...
manifest exactly — nested entries included, version-matched against the installed copy, unlisted
leftovers pruned — regardless of how the developer's package manager hoisted `node_modules`, and
